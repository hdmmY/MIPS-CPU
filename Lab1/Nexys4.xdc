...
#set_property -dict {PACKAGE_PIN J15 IOSTANDARD LVCMOS33} [get_ports {fanh}]
#set_property -dict { PACKAGE_PIN L16   IOSTANDARD LVCMOS33 } [get_ports { yuan1 }]; #IO_L3N_T0_DQS_EMCCLK_14 Sch=sw[1]
#set_property -dict { PACKAGE_PIN M13   IOSTANDARD LVCMOS33 } [get_ports { yuan2 }]; #IO_L6N_T0_D08_VREF_14 Sch=sw[2]
#set_property -dict { PACKAGE_PIN R15   IOSTANDARD LVCMOS33 } [get_ports { yuan3 }]; #IO_L13N_T2_MRCC_14 Sch=sw[3]
...
#set_property -dict {PACKAGE_PIN V10 IOSTANDARD LVCMOS33} [get_ports {dianyuan}]


## LEDs

#set_property -dict {PACKAGE_PIN H17 IOSTANDARD LVCMOS33} [get_ports {sa}]
#set_property -dict {PACKAGE_PIN K15 IOSTANDARD LVCMOS33} [get_ports {sb}]
#set_property -dict {PACKAGE_PIN J13 IOSTANDARD LVCMOS33} [get_ports {sc}] 
#set_property -dict {PACKAGE_PIN N14 IOSTANDARD LVCMOS33} [get_ports {sd}] 
#set_property -dict {PACKAGE_PIN R18 IOSTANDARD LVCMOS33} [get_ports {se}] 
...
#set_property -dict {PACKAGE_PIN V12 IOSTANDARD LVCMOS33} [get_ports {sg}] 
#set_property -dict {PACKAGE_PIN V11 IOSTANDARD LVCMOS33} [get_ports {sf}] 
...
#set_property -dict {PACKAGE_PIN N17 IOSTANDARD LVCMOS33} [get_ports {inabc}]
#set_property -dict {PACKAGE_PIN M18 IOSTANDARD LVCMOS33} [get_ports {yuan1}]
#set_property -dict {PACKAGE_PIN P17 IOSTANDARD LVCMOS33} [get_ports {yuan2}]
#set_property -dict {PACKAGE_PIN M17 IOSTANDARD LVCMOS33} [get_ports {yuan3}]
#set_property -dict { PACKAGE_PIN P18   IOSTANDARD LVCMOS33 } [get_ports {fanh}]; #IO_L9N_T1_DQS_D13_14 Sch=btnd
